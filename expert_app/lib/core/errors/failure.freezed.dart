...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String message)?  server,TResult Function( String message)?  network,TResult Function( String message)?  cache,TResult Function( String message)?  unauthorized,TResult Function( String message)?  validation,TResult Function( String message)?  unexpected,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ServerFailure() when server != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message)  server,required TResult Function( String message)  network,required TResult Function( String message)  cache,required TResult Function( String message)  unauthorized,required TResult Function( String message)  validation,required TResult Function( String message)  unexpected,}) {final _that = this;
switch (_that) {
case ServerFailure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String message)?  server,TResult? Function( String message)?  network,TResult? Function( String message)?  cache,TResult? Function( String message)?  unauthorized,TResult? Function( String message)?  validation,TResult? Function( String message)?  unexpected,}) {final _that = this;
switch (_that) {
case ServerFailure() when server != null:
return server(_that.message);case NetworkFailure() when network != null:
return network(_that.message);case CacheFailure() when cache != null:
...
class ServerFailure implements Failure {
  const ServerFailure({this.message = 'Server xətası baş verdi'});
...
class NetworkFailure implements Failure {
  const NetworkFailure({this.message = 'İnternet bağlantısı yoxdur'});
...
class CacheFailure implements Failure {
  const CacheFailure({this.message = 'Yaddaş xətası baş verdi'});
...
class UnauthorizedFailure implements Failure {
  const UnauthorizedFailure({this.message = 'Yetki yoxdur, yenidən daxil olun'});
...
class ValidationFailure implements Failure {
  const ValidationFailure({this.message = 'Daxil edilən məlumat düzgün deyil'});
...
class UnexpectedFailure implements Failure {
  const UnexpectedFailure({this.message = 'Gözlənilməz xəta baş verdi'});
