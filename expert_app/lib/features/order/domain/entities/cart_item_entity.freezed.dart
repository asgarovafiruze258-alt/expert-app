...
mixin _$CartItemEntity {
 ...
 MaterialEntity get material; int get quantity;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartItemEntity&&(identical(other.material, material) || other.material == material)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
...
@override
String toString() {
  return 'CartItemEntity(material: $material, quantity: $quantity)';
}
...
@useResult
$Res call({
 MaterialEntity material, int quantity
});
...
/// Create a copy of CartItemEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? material = null,Object? quantity = null,}) {
  return _then(_self.copyWith(
material: null == material ? _self.material : material // ignore: cast_nullable_to_non_nullable
as MaterialEntity,quantity: null == quantity ? _self.quantity : quantity // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
/// Create a copy of CartItemEntity
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( MaterialEntity material,  int quantity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartItemEntity() when $default != null:
return $default(_that.material,_that.quantity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( MaterialEntity material,  int quantity)  $default,) {final _that = this;
switch (_that) {
case _CartItemEntity():
return $default(_that.material,_that.quantity);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( MaterialEntity material,  int quantity)?  $default,) {final _that = this;
switch (_that) {
case _CartItemEntity() when $default != null:
return $default(_that.material,_that.quantity);case _:
  return null;
...
class _CartItemEntity extends CartItemEntity {
  const _CartItemEntity({required this.material, required this.quantity}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CartItemEntity&&(identical(other.material, material) || other.material == material)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
...
/// Create a copy of CartItemEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? material = null,Object? quantity = null,}) {
