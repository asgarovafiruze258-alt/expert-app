...
@override
String toString() {
  return 'ShopModel(id: $id, name: $name, logoUrl: $logoUrl, address: $address, rayon: $rayon, rating: $rating, isApproved: $isApproved)';
}
...
class _ShopModel extends ShopModel {
  const _ShopModel({required this.id, required this.name, this.logoUrl, this.address, this.rayon, required this.rating, required this.isApproved}): super._();
