...
@override
String toString() {
  return 'MaterialEntity(id: $id, shopId: $shopId, shopName: $shopName, categoryId: $categoryId, name: $name, description: $description, images: $images, price: $price, discountPrice: $discountPrice, unit: $unit, stockQty: $stockQty, isFeatured: $isFeatured)';
}
...
class _MaterialEntity implements MaterialEntity {
  const _MaterialEntity({required this.id, required this.shopId, this.shopName, required this.categoryId, required this.name, this.description, final  List<String> images = const <String>[], required this.price, this.discountPrice, this.unit = 'ədəd', this.stockQty = 0, this.isFeatured = false}): _images = images;
