...
mixin _$CategoryEntity {
 ...
 String get id; String get name; String? get nameEn; String? get nameRu; String? get iconUrl; CategoryType get type; String? get parentId;
...
@override
String toString() {
  return 'CategoryEntity(id: $id, name: $name, nameEn: $nameEn, nameRu: $nameRu, iconUrl: $iconUrl, type: $type, parentId: $parentId)';
}
...
@useResult
$Res call({
 String id, String name, String? nameEn, String? nameRu, String? iconUrl, CategoryType type, String? parentId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? nameEn,  String? nameRu,  String? iconUrl,  CategoryType type,  String? parentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? nameEn,  String? nameRu,  String? iconUrl,  CategoryType type,  String? parentId)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? nameEn,  String? nameRu,  String? iconUrl,  CategoryType type,  String? parentId)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.nameEn,_that.nameRu,_that.iconUrl,_that.type,_that.parentId);case _:
  return null;
...
class _CategoryEntity implements CategoryEntity {
  const _CategoryEntity({required this.id, required this.name, this.nameEn, this.nameRu, this.iconUrl, required this.type, this.parentId});
