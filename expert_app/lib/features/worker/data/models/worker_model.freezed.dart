...
@override
String toString() {
  return 'WorkerModel(id: $id, fullName: $fullName, avatarUrl: $avatarUrl, bio: $bio, experienceYears: $experienceYears, priceFrom: $priceFrom, priceTo: $priceTo, serviceAreas: $serviceAreas, portfolioImages: $portfolioImages, contactPhone: $contactPhone, rating: $rating, reviewCount: $reviewCount, isOnline: $isOnline, isAvailable: $isAvailable, isApproved: $isApproved, categoryNames: $categoryNames)';
}
...
class _WorkerModel extends WorkerModel {
  const _WorkerModel({required this.id, required this.fullName, this.avatarUrl, this.bio, required this.experienceYears, this.priceFrom, this.priceTo, required final  List<String> serviceAreas, required final  List<String> portfolioImages, this.contactPhone, required this.rating, required this.reviewCount, required this.isOnline, required this.isAvailable, required this.isApproved, required final  List<String> categoryNames}): _serviceAreas = serviceAreas,_portfolioImages = portfolioImages,_categoryNames = categoryNames,super._();
...
@override List<String> get serviceAreas {
...
@override List<String> get portfolioImages {
