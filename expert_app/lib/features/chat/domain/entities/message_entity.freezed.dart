...
mixin _$MessageEntity {
 ...
 String get id; String get chatId; String get senderId; MessageType get type; String? get content; String? get mediaUrl; bool get isRead; DateTime get createdAt;
...
@override
String toString() {
  return 'MessageEntity(id: $id, chatId: $chatId, senderId: $senderId, type: $type, content: $content, mediaUrl: $mediaUrl, isRead: $isRead, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String chatId, String senderId, MessageType type, String? content, String? mediaUrl, bool isRead, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String chatId,  String senderId,  MessageType type,  String? content,  String? mediaUrl,  bool isRead,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String chatId,  String senderId,  MessageType type,  String? content,  String? mediaUrl,  bool isRead,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _MessageEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String chatId,  String senderId,  MessageType type,  String? content,  String? mediaUrl,  bool isRead,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _MessageEntity() when $default != null:
return $default(_that.id,_that.chatId,_that.senderId,_that.type,_that.content,_that.mediaUrl,_that.isRead,_that.createdAt);case _:
  return null;
...
class _MessageEntity implements MessageEntity {
  const _MessageEntity({required this.id, required this.chatId, required this.senderId, required this.type, this.content, this.mediaUrl, required this.isRead, required this.createdAt});
