...
mixin _$NotificationModel {
 ...
 String get id; String get type; String get title; String? get body; Map<String, dynamic>? get payload; bool get isRead; String get createdAt;
...
@override
String toString() {
  return 'NotificationModel(id: $id, type: $type, title: $title, body: $body, payload: $payload, isRead: $isRead, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String type, String title, String? body, Map<String, dynamic>? payload, bool isRead, String createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String type,  String title,  String? body,  Map<String, dynamic>? payload,  bool isRead,  String createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String type,  String title,  String? body,  Map<String, dynamic>? payload,  bool isRead,  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String type,  String title,  String? body,  Map<String, dynamic>? payload,  bool isRead,  String createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationModel() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.body,_that.payload,_that.isRead,_that.createdAt);case _:
  return null;
...
class _NotificationModel extends NotificationModel {
  const _NotificationModel({required this.id, required this.type, required this.title, this.body, final  Map<String, dynamic>? payload, required this.isRead, required this.createdAt}): _payload = payload,super._();
